module Numeric.YHSeq.V0111
  ...
  import Numeric.YHSeq.V0111.Compression   (seqClass, compress)
  import Numeric.YHSeq.V0111.Expansion     (expand)
  import Numeric.YHSeq.V0111.Decompression (decompress)
