module Numeric.YHSeq.V0200Spec (spec) where

  import Prelude hiding (length)

  import Test.Hspec

  import Numeric.YHSeq.V0200
  ...
  spec = do
    ...
    describe "fseq" $ do
      ...
      it "expands (1,2,4,8,10,8) to (1,2,4,8,10,7,12,14,11,17,19,...)" $ do
        fseq [1,2,4,8,10,8] 2 `shouldBe` [1,2,4,8,10,7,12,14,11,17,19]
