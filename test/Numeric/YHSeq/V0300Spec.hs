module Numeric.YHSeq.V0300Spec (spec) where
  ...
  spec = runIO $ do
    ...
    print (expandMtAtLim1 (calcMtFromList [1,2,4]) 5)
    print "expandSeq (makeSeqFromList [1,2,4,8,10,8]) 5"
    print (expandSeq (makeSeqFromList [1,2,4,8,10,8]) 5)
    ...
    print (calcDiPa (calcMtFromList [1,3,5]) 1 1)
    print "calcDiPa (calcMtFromList [1,3,5]) 2 1"
    print (calcDiPa (calcMtFromList [1,3,5]) 2 1)
    ...
    print (calcDiSeq (calcMtFromList [1,3,9]))
    print "calcDiSeq (calcMtFromList [1,3,9,11,9])"
    print (calcDiSeq (calcMtFromList [1,3,9,11,9]))
    print "calcDiSeq (calcMtFromList [1,3,9,21,9])"
    print (calcDiSeq (calcMtFromList [1,3,9,21,9]))
    print "calcDiSeq (calcMtFromList [1,4.8,11])"
    print (calcDiSeq (calcMtFromList [1,4,8,11]))
